						...
						<Button
							...
							onClick={() => {
								...
								const edit = {
									...
									usAddress1: data?.data?.dataList[0]?.usAddress1,
									usAddress2: data?.data?.dataList[0]?.usAddress2,
									usAddress3: data?.data?.dataList[0]?.usAddress3,
									headAddress1: data?.data?.dataList[0]?.headAddress1,
									headAddress2: data?.data?.dataList[0]?.headAddress2,
									headAddress3: data?.data?.dataList[0]?.headAddress3,
									fax: data?.data?.dataList[0]?.fax,
									tel: data?.data?.dataList[0]?.tel,
									privacyPolicy: data?.data?.dataList[0]?.privacyPolicy,
									fileId: data?.data?.dataList[0]?.fileDto?.fileId,
			...
			>
				...
				>
					...
					<Form.Item label='New Logo'>
						...
						<p>*Current Logo will be replaced with New Image after [Edit]</p>
					</Form.Item>
