...
const Popup = () => {
  ...
  const { mutate: mutateDelete, isSuccess: isSuccessDelete } = useDeletePopup();
  ...
  const hourValidationRule = {
    validator: (_, value) => {
      ...
      return Promise.reject(
        new Error("The value must be a number between 0 and 23")
      );
    },
  };
        ...
        >
          {modalFor === "add" ? (
            <>
              ...
              >
                <Radio.Group initialValue={true} buttonStyle="solid">
                  <Radio.Button key="true" value="true">
                    YES
                  </Radio.Button>
                  <Radio.Button key="false" value="false">
