...
const AdminUser = () => {
  ...
  const { mutate: mutateDelete, isSuccess: isSuccessDelete } = useDeleteAdmin();
        ...
        >
          {modalFor === "add" ? (
            <>
              ...
              {newPassword && passwordConfirm && !passwordMatch && (
                <p style={{ color: "red" }}>Password not matching!</p>
              )}
            ...
            <>
              ...
              >
                <Button
                  disabled={newPassword && passwordConfirm && !passwordMatch}
                  type="primary"
                  onClick={(event) => {
                    event.stopPropagation();
