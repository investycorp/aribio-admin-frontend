                    ...
                    <Button
                        ...
                        onClick={async (event) => {
                            ...
                            let editData = {
                                ...
                                indication:
                                    record.pipelineIndicationDtoList.map(
                                        (item) => ({
    ...
    return (
        <Layout
            ...
            <Modal
                ...
                title={
                    modalFor === "add" ? "Add New Pipeline" : "Edit Pipeline"
                }
                open={isModalOpen}
